...
@Component({
  selector: 'app-medecins-visualisation',
  templateUrl: './medecins-visualisation.component.html',
  styleUrls: ['./medecins-visualisation.component.css']
})
export class MedecinsVisualisationComponent implements OnInit {
  values = '';
